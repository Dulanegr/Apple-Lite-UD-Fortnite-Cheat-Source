...
void DrawESP() {
	...
	if (Settings::EnableHack)
	{
		...
		{
			char dist[64];
			sprintf_s(dist, "", ImGui::GetIO().Framerate);
...
{
	if (Settings::Aimbot)
		WriteStringToIni(XorStr("1").c_str(), XorStr("C:\\config").c_str(), XorStr("options").c_str(), XorStr("aimbot").c_str());
	else
		WriteStringToIni(XorStr("0").c_str(), XorStr("C:\\config").c_str(), XorStr("options").c_str(), XorStr("aimbot").c_str());
	if (Settings::Draw_FOV_Circle)
		WriteStringToIni(XorStr("1").c_str(), XorStr("C:\\config").c_str(), XorStr("options").c_str(), XorStr("drawfov").c_str());
	else
		WriteStringToIni(XorStr("0").c_str(), XorStr("C:\\config").c_str(), XorStr("options").c_str(), XorStr("drawfov").c_str());
	if (Settings::Esp_line)
		WriteStringToIni(XorStr("1").c_str(), XorStr("C:\\config").c_str(), XorStr("options").c_str(), XorStr("snaplines").c_str());
	else
		WriteStringToIni(XorStr("0").c_str(), XorStr("C:\\config").c_str(), XorStr("options").c_str(), XorStr("snaplines").c_str());
	if (Settings::Distance_Esp)
		WriteStringToIni(XorStr("1").c_str(), XorStr("C:\\config").c_str(), XorStr("options").c_str(), XorStr("distance").c_str());
	else
		WriteStringToIni(XorStr("0").c_str(), XorStr("C:\\config").c_str(), XorStr("options").c_str(), XorStr("distance").c_str());
	if (Settings::Esp_Corner_Box)
		WriteStringToIni(XorStr("1").c_str(), XorStr("C:\\config").c_str(), XorStr("options").c_str(), XorStr("boxes").c_str());
	else
		WriteStringToIni(XorStr("0").c_str(), XorStr("C:\\config").c_str(), XorStr("options").c_str(), XorStr("boxes").c_str());
	if (Settings::Cross_Hair)
		WriteStringToIni(XorStr("1").c_str(), XorStr("C:\\config").c_str(), XorStr("options").c_str(), XorStr("crosshair").c_str());
	else
		WriteStringToIni(XorStr("0").c_str(), XorStr("C:\\config").c_str(), XorStr("options").c_str(), XorStr("box").c_str());
	if (Settings::Esp_box)
		WriteStringToIni(XorStr("1").c_str(), XorStr("C:\\config").c_str(), XorStr("options").c_str(), XorStr("box").c_str());
	else
		WriteStringToIni(XorStr("0").c_str(), XorStr("C:\\config").c_str(), XorStr("options").c_str(), XorStr("box").c_str());
	if (Settings::SelfEsp)
		WriteStringToIni(XorStr("1").c_str(), XorStr("C:\\config").c_str(), XorStr("options").c_str(), XorStr("SelfEsp").c_str());
	else
		WriteStringToIni(XorStr("0").c_str(), XorStr("C:\\config").c_str(), XorStr("options").c_str(), XorStr("SelfEsp").c_str());
	if (Settings::Esp_skeleton)
		WriteStringToIni(XorStr("1").c_str(), XorStr("C:\\config").c_str(), XorStr("options").c_str(), XorStr("skeleton").c_str());
	else
		WriteStringToIni(XorStr("0").c_str(), XorStr("C:\\config").c_str(), XorStr("options").c_str(), XorStr("skeleton").c_str());
	if (Settings::Esp_line)
		WriteStringToIni(XorStr("1").c_str(), XorStr("C:\\config").c_str(), XorStr("options").c_str(), XorStr("line").c_str());
	else
		WriteStringToIni(XorStr("0").c_str(), XorStr("C:\\config").c_str(), XorStr("options").c_str(), XorStr("line").c_str());
	WriteStringToIni(std::to_string(Settings::AimFOV), XorStr("C:\\config").c_str(), XorStr("options").c_str(), XorStr("aimfov").c_str());
	WriteStringToIni(std::to_string(Settings::Aim_Speed), XorStr("C:\\config").c_str(), XorStr("options").c_str(), XorStr("smooth").c_str());
	WriteStringToIni(std::to_string(Settings::VisDist), XorStr("C:\\config").c_str(), XorStr("options").c_str(), XorStr("distanceslider").c_str());
}
std::string locof = windira + inf;
void LoadConfig()
{
	if (ReadStringFromIni(XorStr("C:\\config").c_str(), XorStr("options").c_str(), XorStr("aimbot").c_str()) == XorStr("1").c_str())
		Settings::Aimbot = true;
	else
		Settings::Aimbot = false;
	if (ReadStringFromIni(XorStr("C:\\config").c_str(), XorStr("options").c_str(), XorStr("drawfov").c_str()) == XorStr("1").c_str())
		Settings::Draw_FOV_Circle = true;
	else
		Settings::Draw_FOV_Circle = false;
	if (ReadStringFromIni(XorStr("C:\\config").c_str(), XorStr("options").c_str(), XorStr("snaplines").c_str()) == XorStr("1").c_str())
		Settings::Esp_line = true;
	else
		Settings::Esp_line = false;
	if (ReadStringFromIni(XorStr("C:\\config").c_str(), XorStr("options").c_str(), XorStr("distance").c_str()) == XorStr("1").c_str())
		Settings::Distance_Esp = true;
	else
		Settings::Distance_Esp = false;
	if (ReadStringFromIni(XorStr("C:\\config").c_str(), XorStr("options").c_str(), XorStr("boxes").c_str()) == XorStr("1").c_str())
		Settings::Esp_Corner_Box = true;
	else
		Settings::Esp_Corner_Box = false;
	if (ReadStringFromIni(XorStr("C:\\config").c_str(), XorStr("options").c_str(), XorStr("crosshair").c_str()) == XorStr("1").c_str())
		Settings::Cross_Hair = true;
	else
		Settings::Cross_Hair = false;
	if (ReadStringFromIni(XorStr("C:\\config").c_str(), XorStr("options").c_str(), XorStr("box").c_str()) == XorStr("1").c_str())
		Settings::Esp_box = true;
	else
		Settings::Esp_box = false;
	if (ReadStringFromIni(XorStr("C:\\config").c_str(), XorStr("options").c_str(), XorStr("SelfEsp").c_str()) == XorStr("1").c_str())
		Settings::SelfEsp = true;
	else
		Settings::SelfEsp = false;
	if (ReadStringFromIni(XorStr("C:\\config").c_str(), XorStr("options").c_str(), XorStr("skeleton").c_str()) == XorStr("1").c_str())
		Settings::Esp_skeleton = true;
	else
		Settings::Esp_skeleton = false;
	if (ReadStringFromIni(XorStr("C:\\config").c_str(), XorStr("options").c_str(), XorStr("line").c_str()) == XorStr("1").c_str())
		Settings::Esp_line = true;
	else
		Settings::Esp_line = false;
	ReadStringFromIni_Float(XorStr("C:\\config").c_str(), XorStr("options").c_str(), XorStr("aimfov").c_str(), 4);
	Settings::AimFOV = new_aimfov;
	ReadStringFromIni_Float(XorStr("C:\\config").c_str(), XorStr("options").c_str(), XorStr("smooth").c_str(), 5);
	Settings::Aim_Speed = new_aimsmooth;
	ReadStringFromIni_Float(XorStr("C:\\config").c_str(), XorStr("options").c_str(), XorStr("distanceslider").c_str(), 6);
...
void render() {
	...
	if (Settings::Show_Menu) {
		...
		int current = 1;
		{
			...
			if (ImGui::Begin(""), 0, ImGuiWindowFlags_::ImGuiWindowFlags_NoCollapse | ImGuiWindowFlags_::ImGuiWindowFlags_NoResize)
			{
				...
				if (maintabs == 0) {
					...
					ImGui::SetCursorPos({ 13.f,108.f });
					ImGui::PushItemWidth(133.000000);
					ImGui::Text("Aimbot mode");
					ImGui::SetCursorPos({ 13.f,138.f });
					...
					ImGui::SetCursorPos({ 13.f,167.f });
					ImGui::Checkbox("Friendly fire", &Settings::Team_Aimbot);
					if (Settings::Team_Aimbot)
					{
						Settings::Aimbot = false;
						Settings::StickySilent = false;
					}
					ImGui::SetCursorPos({ 13.f,196.f });
					ImGui::Checkbox("Silent", &Settings::StickySilent);
					...
					ImGui::Text("Aimkey");
					ImGui::SetCursorPos({ 13.f,253.f });
					HotkeyButton(hotkeys::aimkey, ChangeKey, keystatus);
					ImGui::SetCursorPos({ 13.f,280.f });
					ImGui::PushItemWidth(140.000000);
					ImGui::Text("Hitbox");
					ImGui::SetCursorPos({ 13.f,300.f });
					...
					ImGui::SetCursorPos({ 13.f,385.f });
					ImGui::Checkbox("Draw FOV", &Settings::Draw_FOV_Circle);

					ImGui::SetCursorPos({ 13.f,415.f });
					ImGui::PushItemWidth(531.000000);
					ImGui::SliderFloat("FOV", &Settings::AimFOV, 1, 1500);

					ImGui::SetCursorPos({ 13.f,445.f });
					ImGui::PushItemWidth(531.000000);
				...
				else if (maintabs == 1)
				{
					...
					ImGui::SetCursorPos({ 235.f,80.f });
					ImGui::PushItemWidth(84.000000);
					ImGui::Text("Players");
					ImGui::SetCursorPos({ 235.f,106.f });
					ImGui::Checkbox("Box", &Settings::Esp_Corner_Box);
					ImGui::SetCursorPos({ 12.f,325.f });
					ImGui::PushItemWidth(319.000000);
					ImGui::SliderFloat("Loot", &Settings::VisDist, 5, 500);
					ImGui::SetCursorPos({ 12.f,300.f });
					ImGui::PushItemWidth(105.000000);
					ImGui::Text("Loot distance");
					ImGui::SetCursorPos({ 12.f,80.f });
					ImGui::PushItemWidth(84.000000);
					ImGui::Text("Loot");
					ImGui::SetCursorPos({ 235.f,134.f });
					ImGui::Checkbox("2D Box", &Settings::Esp_box);
					ImGui::SetCursorPos({ 235.f,162.f });
					ImGui::Checkbox("Name", &Settings::PlayerESP);                                        
					ImGui::SetCursorPos({ 235.f,190.f });
					ImGui::Checkbox("Skeleton", &Settings::Esp_skeleton);
					ImGui::SetCursorPos({ 235.f,218.f });
					ImGui::Checkbox("Line", &Settings::Esp_line);
					//ImGui::SetCursorPos({ 235.f,246.f });
					//ImGui::Checkbox("3D box ", &Settings::ThreeDBox);
					ImGui::SetCursorPos({ 235.f,246.f });
					ImGui::Checkbox("Self ESP", &Settings::SelfEsp);
					ImGui::SetCursorPos({ 435.f,80.f });
					ImGui::PushItemWidth(205.000000);
					ImGui::Text("Loot tier");
					ImGui::SetCursorPos({ 435.f,106.f });
					ImGui::Checkbox("Ultra common", &Settings::Ultracommon);
					ImGui::SetCursorPos({ 435.f,134.f });
					ImGui::Checkbox("Common", &Settings::Common);
					ImGui::SetCursorPos({ 435.f,162.f });
					ImGui::Checkbox("Uncommon", &Settings::Uncommon);
					ImGui::SetCursorPos({ 435.f,190.f });
					ImGui::Checkbox("Rare", &Settings::Rare);
					ImGui::SetCursorPos({ 435.f,218.f });
				...
				else if (maintabs == 2)
				{
					...
					ImGui::Checkbox("Boat Teleport", &Settings::boattp);
				...
				{
					ImGui::SetCursorPos({ 12.f,85.f });
					ImGui::Text("");
					ImGui::SetCursorPos({ 12.f,105.f });
					ImGui::Text("Config");
					ImGui::SetCursorPos({ 12.f,125.f });
					if (ImGui::Button(XorStr("Save").c_str(), { 90.f,20.f }))
					{
...
{																																																																																									
	...
	std::cout << XorStr("Waiting for Fortnite To Start...");
	...
	std::cout << XorStr("Loading.. \n\n");


	SetConsoleTextAttribute(GetStdHandle(STD_OUTPUT_HANDLE), FOREGROUND_INTENSITY | FOREGROUND_GREEN);
	std::cout << XorStr("Succesfully loaded\n\n");
	SetConsoleTextAttribute(GetStdHandle(STD_OUTPUT_HANDLE), FOREGROUND_INTENSITY | FOREGROUND_GREEN);
	std::cout << XorStr("WORKING/UPDATED\n\n");

	SetConsoleTextAttribute(GetStdHandle(STD_OUTPUT_HANDLE), FOREGROUND_INTENSITY | FOREGROUND_GREEN);
	std::cout << XorStr("DO NOT CLOSE THIS MENU!!!\n\n");
